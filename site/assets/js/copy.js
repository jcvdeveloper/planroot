...
window.COPY = {
  ...
  // DONE
  done_title: "Tá liberado. Sua ideia saiu do papel.",
  done_subhead: "Copie o Prompt para IA e cole no Claude, Codex ou ChatGPT — ele já vem pronto pra construir seu projeto. Os arquivos do blueprint também estão disponíveis.",
  download_prompt: "Baixar prompt para IA",
  copy_prompt: "Copiar prompt para IA",
  copy_prompt_done: "Copiado! Cole na sua IA",
